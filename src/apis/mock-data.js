...
export const mockData = {
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://bizweb.dktcdn.net/100/344/954/files/ca-neon-vua-1.jpg?v=1571894429226',
      ...
      // khi column rỗng không kéo card vào được. Sử dụng 1 card trong column và ẩn đi (phía FE)
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
        ...
        cards: [
          { _id: 'column-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-04', memberIds: [], comments: [], attachments: [], FE_PlaceholderCard: true }
        ]
      }
    ]
  }
